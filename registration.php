...
<body class="auth-page auth-page--register" data-auth-guard="guest">
    <main class="register-shell">
        <section class="register-panel" aria-label="Registration form">
            <div class="register-topbar">
                ...
                <a class="register-back" href="public-page.php"><i class="bi bi-arrow-left"></i><span>Back to website</span></a>
            </div>
    ...
    <script src="assets/js/auth-registration-page.js"></script>
</body>
</html>
