    ...
    <div class="dashboard-shell container-fluid">
        <div class="dashboard-frame">
            ...
            <div class="dashboard-main">
                ...
                <main class="dashboard-content settings-dashboard-content" data-mobile-state="collapsed">
                                            ...
                                            <section class="settings-account-section" aria-labelledby="clientProfileTitle">
                                                ...
                                                <div class="settings-field-grid settings-field-grid--account">
                                                    <label class="settings-field">
                                                        ...
                                                        <input class="settings-input" type="text" id="clientFullNameInput" name="full_name" value="<?= $escape($clientFullName) ?>" autocomplete="name" data-auth-input="full_name">
                                                    </label>
                                                    ...
                                                    <label class="settings-field settings-field--full">
                                                        ...
                                                        <input class="settings-input" id="alternateContactInput" name="alternate_contact" type="text" value="<?= $escape($clientAlternateContact) ?>" placeholder="Name and mobile number">
                                                    </label>
                                                </div>
                                            </section>
                                        </div>
