...
<head>
    ...
    <link rel="stylesheet" href="assets/css/public-page.css?v=20260412ac">
    <link rel="stylesheet" href="assets/css/public-page-overrides.css?v=20260411f">
</head>
<body class="public-page">
                        ...
                        <?php foreach ($galleryCards as $galleryCard): ?>
                            ...
                            <article class="gallery-card<?= $galleryCardImageUrl === '' ? ' gallery-card--empty' : '' ?>" data-category="<?= $escape($galleryCardFilterCategory) ?>" data-reveal>
                                <?php if ($galleryCardImageUrl !== ''): ?>
                                    <img src="<?= $escape($galleryCardImageUrl) ?>" alt="<?= $escape($galleryCardImageAlt) ?>" loading="lazy">
                                <?php else: ?>
    ...
    <script src="assets/js/public-page.js?v=20260412h"></script>
</body>
</html>
