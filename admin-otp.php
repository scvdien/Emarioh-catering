...
<head>
    ...
    <link rel="stylesheet" href="assets/css/login.css?v=20260403a">
    <link rel="stylesheet" href="assets/css/admin-auth.css?v=20260408a">
</head>
<body class="auth-page auth-page--login admin-access-page">
    ...
    <script src="assets/js/admin-auth-ui.js?v=20260408a"></script>
</body>
</html>
