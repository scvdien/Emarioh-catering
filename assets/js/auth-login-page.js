(function (window, document) {
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function showQueryMessage() {
            ...
            if (params.get("reason") === "admin_only") {
                showFeedback("Log in with an admin account to access that page.", "error");
                return;
            }

            if (params.get("reason") === "client_only") {
                showFeedback("Log in with a client account to access that page.", "error");
                return;
            }

            if (params.get("reason") === "session") {
                showFeedback("Your session could not be confirmed. Please log in again.", "error");
            }
        }
